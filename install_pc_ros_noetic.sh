...
sh -c "echo \"#AiCONTROL CAMP-1 Setting\" >> ~/.bashrc"
sh -c "echo \"export AiCON_MODEL=CAMP-1\" >> ~/.bashrc"
sh -c "echo \"export LIDAR_MODEL=LDS-02\" >> ~/.bashrc"
sh -c "echo \"#export LIDAR_MODEL=YDLIDAR\" >> ~/.bashrc"
...
sudo apt-get install -y ros-noetic-joy ros-noetic-teleop-twist-joy \
  ...
  ros-noetic-turtlebot3-msgs libudev-dev
sudo apt install -y ros-noetic-image-transport ros-noetic-cv-bridge ros-noetic-vision-opencv python3-opencv libopencv-dev ros-noetic-image-proc ros-noetic-cv-camera ros-noetic-camera-calibration
